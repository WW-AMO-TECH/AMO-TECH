    ...
    <footer className="border-t border-border/50 py-8 px-4 md:px-8">
      <div className="container-narrow">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            <h4 className="font-semibold text-smcon mb-4">Quick Links</h4>
            <ul className="space-y-2.5 text-sm text-muted-foreground">
              <li><a href="/contact-us" className="hover:text-foreground transition-colors">Contact</a></li>
              <li><a href="/book" className="hover:text-foreground transition-colors">Get a Free Audit</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border/50 pt-8 space-y-4">
          <div className="text-center">
            <p className="text-sm font-semibold mb-3">Trusted by 30+ Service Providers</p>
            <div className="flex flex-wrap items-center justify-center gap-2 mb-4">
              {["GAF Certified", "Owens Corning Preferred", "BBB A+", "ASSE International", "HAAG Certified", "IICRC", "EPA Section 608", "NATE", "ISO 9001"].map((badge) => (
